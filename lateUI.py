...
class ui_frame:
    ...
    def meta_data_test(self):
        ...
        if self.meta_check_1.get() == self.meta_check_2.get() == 0:
            ...
            if self.meta_check_1.get() == self.meta_check_2.get() == 1:
                ...
                if "Hop1_MetaData_Input" in wb.sheetnames and 'Hop2_MetaData_Input' in wb.sheetnames:
                    meta_data_log.info(" Both check box inputs selected ")
                    # hop1 sheet
                    sheet = wb['Hop1_MetaData_Input']
                    sheet_col = sheet.max_column
                    # hop2 sheet
                    sheet2 = wb['Hop2_MetaData_Input']
                    sheet2_col = sheet2.max_column
                    if sheet.max_row >= 2:
                        if sheet2.max_row >= 2:
                            ...
                            for row in range(1, sheet.max_row + 1):
                                try:
                                    for col in range(1, sheet_col + 1):
                                        ...
                                        if c is not None:
                                            ...
                                            tk.messagebox.showinfo("error",
                                                                   "Metadata-Hop1 Input sheet have empty values")
                            ...
                            for row in range(1, sheet2.max_row + 1):
                                try:
                                    for col in range(1, sheet2_col + 1):
                                        c = sheet2.cell(row=row, column=col).value
                                        # print(c)
                                        if c is not None:
                                            pass
                                        else:
                                            tk.messagebox.showinfo("error",
                                                                   "Metadata-Hop2 Input sheet have empty values")
                                            meta_data_log.error(" Input sheet with empty cells ")
                                            break
                                except Exception as e:
                                    print(e)
                ...
                if "Hop1_MetaData_Input" in wb.sheetnames:
                    sheet_Hop1 = wb['Hop1_MetaData_Input']

                    if sheet_Hop1.max_row >= 2:
                        meta_data_log.info(" The input sheets have more than 1 record ")

                        for row in range(1, sheet_Hop1.max_row + 1):
                            try:
                                for col in range(1, sheet_Hop1.max_column + 1):
                                    c = sheet_Hop1.cell(row=row, column=col).value
                                    # print(c)
                                    if c is not None:
                                        pass
                                    else:
                ...
                if "Hop2_MetaData_Input" in wb.sheetnames:

                    sheet_Hop2 = wb['Hop2_MetaData_Input']
                    if sheet_Hop2.max_row >= 2:
                        meta_data_log.info("The input sheet have more than 1 record")
                        for row in range(1, sheet_Hop2.max_row + 1):
                            try:
                                for col in range(1, sheet_Hop2.max_column + 1):
                                    c = sheet_Hop2.cell(row=row, column=col).value
                                    print(c)
                                    if c is not None:
                                        pass
                                    else:
                                        tk.messagebox.showinfo("error", "Metadata-Hop2 Input sheet have empty values")
                                        meta_data_log.error(" Input sheet with empty cells ")
                                        break
                            except Exception as e:
                                print(e)
    ...
    def data_integrity_test(self):
        ...
        if self.integrity_check_1.get() == self.integrity_check_2.get() == 0:
            ...
            filename = filedialog.askopenfilename(initialdir="C:/", title="select file")
            wb = openpyxl.load_workbook(filename)
            data_integrity_log.info(" File location " + filename)
            print(wb.sheetnames)
            if self.integrity_check_1.get() == self.integrity_check_2.get() == 1:
                data_integrity_log.info(" Both check boxes selected ")
                if "Hop1_DataIntegrity_Input" in wb.sheetnames and 'Hop2_DataIntegrity_Input' in wb.sheetnames:
                    data_integrity_log.info("Both Hop1 and Hop2 Sheets present")
                    sheet = wb['Hop1_DataIntegrity_Input']
                    sheet_col = sheet.max_column
                    sheet2 = wb['Hop2_DataIntegrity_Input']
                    sheet2_col = sheet2.max_column
                    if sheet.max_row >= 2:
                        if sheet2.max_row >= 2:
                            ...
                            for row in range(1, sheet.max_row + 1):
                                try:
                                    for col in range(1, sheet.max_column - 1):
                                        cell_v = sheet.cell(row=row, column=col).value
                                        # print(cell_v)
                            ...
                            for row in range(1, sheet2.max_row + 1):
                                try:
                                    for col in range(1, sheet2.max_column - 1):
                                        cell_v = sheet2.cell(row=row, column=col).value
                                        # print(cell_v)
                                        if cell_v is not None:
                                            # print("present")
                                            pass
                                            ...
                                            tk.messagebox.showinfo("error",
                                                                   "DataIntegrity-Hop2 Input sheet have empty values")
                                            data_integrity_log.error("DataIntegrity-Hop2 Input sheet have empty values")
                                            break
                                    else:
                                        pass
                                        # code to added
                ...
                sheet_Hop1 = wb['Hop1_DataIntegrity_Input']

                if sheet_Hop1.max_row >= 2:
                    for row in range(1, sheet_Hop1.max_row + 1):
                        try:
                            for col in range(1, sheet_Hop1.max_column - 1):
                                cell_v = sheet_Hop1.cell(row=row, column=col).value
                                # print(cell_v)
                                if cell_v is not None:
                                    # print("present")
                                    pass
                ...
                sheet_Hop2 = wb['Hop2_DataIntegrity_Input']

                if sheet_Hop2.max_row >= 2:
                    for row in range(1, sheet_Hop2.max_row + 1):
                        try:
                            for col in range(1, sheet_Hop2.max_column - 1):
                                cell_v = sheet_Hop2.cell(row=row, column=col).value
                                # print(cell_v)
                                if cell_v is not None:
                                    # print("present")
                                    pass
    ...
    def data_quality_test(self):
        ...
        if self.quality_check.get() == 0:
            ...
            if self.quality_check.get() == 1:
                ...
                if 'Hop2_DataQuality_Input' in wb.sheetnames:
                    sheet_hop2 = wb['Hop2_DataQuality_Input']

                    if sheet_hop2.max_row > 2:
                        data_quality_log.info("The sheet has more than 1 record")
                        for row in range(2, sheet_hop2.max_row + 1):
                            for col in range(1, sheet_hop2.max_column - 1):
                                cells_present_flag = 1
                                try:
                                    cell_value = sheet_hop2.cell(row, col).value
                                    # print(cell_value)
                                    if cell_value:
                                        # print("present" + r)
                                        pass
                            ...
                            if 1 == cells_present_flag:
                                table_name = sheet_hop2.cell(row, 3).value
                                ...
                                choose_Validation_check = sheet_hop2.cell(row, 6).value
                                print("VALIDATION CHOSSED  _ ", choose_Validation_check)
                                if choose_Validation_check == 'Null Check':
                                    ...
                                    sheet_hop2.cell(row=row , column=8).value = dq_null_check
                                    ...
                                    if ml_source_employee == ml_target_employee:
                                        ...
                                        dq_trunc_check = "fail"
                                    sheet_hop2.cell(row=row, column=8).value = dq_trunc_check
                                    ...
                                    self.cursor.execute(
                                        "select Employee_name, count(*) from {} group by Employee_name having count("
                                        "*) > 1".format(
                                            table_name))
                                    ...
                                    self.cursor.execute(
                                        "select employee_level_code, count(*) from {} group by employee_level_code "
                                    ...
                                    sheet_hop2.cell(row=row, column=8).value = dq_duplicate_check
                                    ...
                                    sheet_hop2.cell(row=row, column=8).value = dq_num_check
                                    ...
                                    print("date check ")
                                    print(dq_date_check)
                                    sheet_hop2.cell(row=row, column=8).value = dq_date_check
    ...
    def data_completeness_test(self):
        ...
        if self.completeness_check.get() == 0:
            ...
            if self.completeness_check.get() == 1:
                ...
                sheet_Hop1 = wb['Hop1_DataCompleteness_Input']
                if sheet_Hop1.max_row >= 2:
                    data_completeness_log.info("The sheet has more than 1 Record")
                    for row in range(1, sheet_Hop1.max_row + 1):
                        try:
                            for col in range(1, sheet_Hop1.max_column - 2):
                                cell_v = sheet_Hop1.cell(row=row, column=col).value
                                # print(cell_v)
                                if cell_v is not None:
                                    # print("present")
                                    ...
                                    tk.messagebox.showinfo("error",
                                                           "DataCompleteness-Hop1 Input sheet have empty values")
    ...
    def data_cleansing_test(self):
        ...
        if self.cleansing_check.get() == 0:
            ...
            if self.cleansing_check.get() == 1:
                ...
                sheet_Hop2 = wb['Hop2_DataCleansing_Input']
                if sheet_Hop2.max_row >= 2:
                        ...
                        try:
                            for col in range(1, sheet_Hop2.max_column - 1):
                                ...
                                if cell_v is not None:
                                    ...
                                    tk.messagebox.showinfo("error",
                                                           "DataCleansing-Hop2 Input sheet have empty values")
    ...
    def hop2_xml_data_load_test(self):
        ...
        if self.xml_data_load_check.get() == 0:
            ...
            if self.xml_data_load_check.get() == 1:
                print("hop 2 is selected with variable " + str(self.integrity_check_1.get()))
                sheet_Hop2 = wb['Hop2 - XML Data Load Test_Input']
                if sheet_Hop2.max_row >= 2:
                        ...
                        try:
                            for col in range(1, sheet_Hop2.max_column + 1):
                                ...
                                if cell_v is not None:
                                    ...
                                    tk.messagebox.showinfo("error",
                                                           "XML Data Load Test-Hop2 Input sheet have empty values")
    ...
    def hop3_stored_proc_test(self):
        ...
        if self.stored_proc_check.get() == 0:
            ...
            if self.stored_proc_check.get() == 1:
                ...
                sheet_Hop3 = wb['Hop3_Store_Proc_Input']
                if sheet_Hop3.max_row >= 2:
                    hop3_stored_proc_log.info("The sheet has more than 1 record")

                    for row in range(1, sheet_Hop3.max_row + 1):
                        try:
                            for col in range(1, sheet_Hop3.max_column ):
                                cell_v = sheet_Hop3.cell(row=row, column=col).value
                                print(cell_v)
                                if cell_v is not None:
                                    # print("present")
                                    pass
                                    ...
                                    tk.messagebox.showinfo("error",
                                                           "Store_Proc-Hop3 Input sheet have empty values")
                                    hop3_stored_proc_log.error(
                                        "Store_Proc-Hop3 Input sheet have empty values")
                                    break
                            else:
                                pass
